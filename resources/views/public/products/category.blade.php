...
@section('meta_description', $category->meta_description ?? 'Sewa ' . $category->name . ' berkualitas untuk acara Anda.
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        @forelse($products as $product)
                            <div class="card group">
                                <div
                                    class="aspect-[4/3] bg-slate-100 relative overflow-hidden group-hover:opacity-90 transition-opacity">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="mt-1 text-sm text-slate-600 line-clamp-2">{{ $product->short_description }}
                                    </p>
